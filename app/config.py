...
# Tên model embedding dùng chung cho cả 2 luồng: encode mô tả ứng viên và encode câu query
...
# Số lượng ứng viên phù hợp nhất trả về mặc định trong 1 lần match
